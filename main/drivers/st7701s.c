...
void st7701s_screen_init(vernon_st7701s_handle st7701s_handle, unsigned char type)
{
    ...
    {//从Arduino GFX库移植的初始化代码
        ...
        SPI_WriteComm(0xB0); // Vop=4.7375v
        SPI_WriteData(0x60);
        
        SPI_WriteComm(0xB1); // VCOM=32
        SPI_WriteData(0x32);
        
        SPI_WriteComm(0xB2); // VGH=15v
        SPI_WriteData(0x07);
        
        SPI_WriteComm(0xB3);
        SPI_WriteData(0x80);
        
        SPI_WriteComm(0xB5); // VGL=-10.17v
        SPI_WriteData(0x49);
        
        SPI_WriteComm(0xB7);
        SPI_WriteData(0x85);
        
        SPI_WriteComm(0xB8); // AVDD=6.6 & AVCL=-4.6
        SPI_WriteData(0x21);
        ...
        SPI_WriteComm(0x20);   // 0x20 normal, 0x21 IPS
